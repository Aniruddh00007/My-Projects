...
<header>
   <div style="font-size: 60px;">🌿</div>
    <h1>List of Workers Requests</h1>
</header>
        ...
        <tbody>
            <% 
                try {
                    ...
                    String s = "SELECT * FROM work_with_us";
            ...
            %>
                <tr>
                    ...
                    <td><%= r.getString("service") %></td>
                    <td><%= r.getString("note") %></td>
                    <td>
                        <a href="deleteworkers.jsp?myid=<%= r.getString("id") %>"
