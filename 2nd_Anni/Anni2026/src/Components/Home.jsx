...
const journey = [
  ...
  },
  {
    ...
    message: "Our first fight, but definitely not the end of us.",
    details:
      "Write the funny/light version of your first fight here and how you both sorted everything out.",
    photo: "/photos/first-fight.jpg",
  },
  {
    id: 6,
    icon: "✈️",
    ...
    details:
      "Write your trip story here. Add funny moments and your favorite memory from the trip.",
    photo: "/photos/first-trip.jpg",
  },
  {
    id: 7,
    icon: "💍",
    ...
    details:
      "Write your anniversary memory and special message here.",
